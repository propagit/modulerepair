...
/* front end routes */
//$route['(:any)/(:any)'] = 'dispatcher/user_dispatcher/$1/$2';
...
$route['contact-us'] = 'dispatcher/user_dispatcher/pages/contact-us';
$route['send-contact-msg'] = 'dispatcher/user_dispatcher/pages/send_contact_msg';
$route['page/(:any)'] = 'dispatcher/user_dispatcher/pages/page/$1';

/* case studies */
$route['preview-story/(:any)'] = 'dispatcher/user_dispatcher/case_studies/preview-story/$1';
$route['case-studies'] = 'dispatcher/user_dispatcher/case_studies/case-studies';
$route['case-studies/(:any)'] = 'dispatcher/user_dispatcher/case_studies/case-studies/$1';

/* news */
$route['preview-news/(:any)'] = 'dispatcher/user_dispatcher/news/preview-news/$1';
$route['recent-news'] = 'dispatcher/user_dispatcher/news/recent-news';
$route['recent-news/(:any)'] = 'dispatcher/user_dispatcher/news/recent-news/$1';

$route['company'] = 'dispatcher/user_dispatcher/pages/company';

$route['client'] = 'dispatcher/user_dispatcher/client';
$route['client/(:any)'] = 'dispatcher/user_dispatcher/client/$1';
$route['client/(:any)/(:any)'] = 'dispatcher/user_dispatcher/client/$1/$2';

$route['gallery'] = 'dispatcher/user_dispatcher/gallery';
