...
<div class="row">
	<div class="col-md-12">
		<div class="title-page">CREATE CUSTOMER</div>
		<button class="btn btn-info" onclick="window.location = '<?=base_url()?>admin/customer';">Back To Customer List</button>
		...
		<form method="post" action="<?=base_url()?>admin/customer/create" autocomplete="off">
			<div>
				...
				<div class="form-common-input">
					<input type="text" class="form-control input-text" id="firstname" name="firstname" required="required"/>
				</div>
			</div>
			...
			<div>
				...
				<div class="form-common-input">
					<input type="text" class="form-control input-text" id="lastname" name="lastname" required="required"/>
				</div>
			</div>
			<div class="form-common-gap">&nbsp;</div>
			<!--<div>
			...
			<div>
				...
				<div class="form-common-input">
					<input type="text" class="form-control input-text" id="email" name="email" onchange="email_copy();" required="required"/>
				</div>
			</div>
			<div class="form-common-gap">&nbsp;</div>
			<div>
			...
			<div>
				...
				<div class="form-common-input">
					<input type="text" class="form-control input-text" id="fax" name="fax"/>
				</div>
			</div>
			<div class="form-common-gap">&nbsp;</div>
			...
			<div>
				...
				<div class="form-common-input">
					<input type="text" class="form-control input-text" id="postcode" name="postcode"/>
				</div>
			</div>
            <div class="form-common-gap">&nbsp;</div>
			<div>
				<div class="form-common-label">Contact Name 1</div>
				<div class="form-common-input">
					<input type="text" class="form-control input-text" id="contact1" name="contact1"/>
				</div>
			</div>
            <div class="form-common-gap">&nbsp;</div>
			<div>
				<div class="form-common-label">Contact Name 2</div>
				<div class="form-common-input">
					<input type="text" class="form-control input-text" id="contact2" name="contact2"/>
				</div>
			</div>
            <div class="form-common-gap">&nbsp;</div>
			<div>
				<div class="form-common-label">Discount</div>
				<div class="form-common-input">
					<select class="selectpicker" name="discount_level" id="discount_level" >                       
